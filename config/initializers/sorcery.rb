...
Rails.application.config.sorcery.configure do |config|
  ...
  config.facebook.key = "131410173606" # TODO facebook key
  config.facebook.secret = "3bbae143add139e71bd34bf4668358d1" # TODO facebook secret
  config.facebook.callback_url = "http://fbksedlcany.cz/oauth/callback?provider=facebook" # TODO facebook callback
